...
export async function InsertOne (collection: string, query: Object, callback?: Function) {
    try {
...
export async function InsertMany (collection: string, query: object[], callback?: Function)  {
    try {
...
export async function FindOne(collection: string, query: object, callback?: Function) {
    try {
...
export async function FindMany(collection: string, query: object, callback?: Function)  {
    try {
...
export async function UpdateOne (collection: string, query: object, newData: object, callback?: Function)  {
    try {
...
export async function UpdateMany (collection: string, query: object, newData: object, callback?: Function)  {
    try {
...
export async function DeleteOne (collection: string, query: object, callback?: Function)  {
    try {
...
export async function DeleteMany (collection: string, query: object, callback?: Function)  {
    try {
